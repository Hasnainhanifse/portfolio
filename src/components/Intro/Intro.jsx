    ...
    <div className="Intro" id="Intro">
      ...
      <div className="i-left">
        ...
        <div className="i-icons">
          <a href={socialAccounts.github} target="_blank" rel="noreferrer">
            <img src={Github} alt="Github" />
          </a>
          <a href={socialAccounts.instagram} target="_blank" rel="noreferrer">
            <img src={Instagram} alt="Instagram" />
          </a>
          <a href={socialAccounts.linkedin} target="_blank" rel="noreferrer">
