...
export const activeSection = (value) => {
  const sections = document.querySelectorAll(".rs_tm_section");
  sections.forEach((section) => {
    let id = section.getAttribute("id");
    if (id == value) {
      section.className = "rs_tm_section active wow animated fadeInUp";
    } else {
      section.className = "rs_tm_section hidden animated";
    }
  });
};
